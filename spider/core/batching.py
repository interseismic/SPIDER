...
def _log(*parts, section: str = "BATCH", **_kwargs) -> None:
...
def _prepare_owner_buckets(
    ...
    *,
    ...
    if reorder_all:
        ...
        # This can improve locality for correlated likelihoods that group by component.
    ...
    # for better memory locality in station-dependent likelihoods.
