...
def save_samples_periodic(
    ...
    *,
    ...
    try:
        ...
        print(f"[Samples] Starting save: {n_samples} samples, {n_events_in} events", flush=True)
        ...
        print(f"[Samples] Validating and staging samples on CPU...", flush=True)
        ...
        if n_events != n_events_in:
             print(f"[Samples] Warning: n_events mismatch! samples={n_events}, X_src={n_events_in}", flush=True)
        ...
        # 2. Open HDF5
        print(f"[Samples] Opening HDF5: {store_path}", flush=True)
        ...
        print(f"[Samples] Creating group {batch_name}", flush=True)
        ...
        # 5. Write in chunks
        print(f"[Samples] Writing datasets in chunks of {chunk_events}...", flush=True)
        ...
        f.flush()
        f.close()
        print(f"[Samples] Successfully wrote batch {batch_idx}", flush=True)
        return sample_count
